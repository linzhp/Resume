...
Projects:
\begin{itemize}
\item Worked on \textsc{CHEKOFV} project, funded by DARPA's CSFV program, that tried to build games for cloud source based formal verification. In the first game, \textit{Xylem}, I worked as the main backend (Node.js and Express) developer and one of key developers of the game client (ActionScript 3). In the second game, \textit{Binary Fission}, I worked as the main backend (Python and Flask) developer.
