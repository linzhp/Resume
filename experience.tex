...
{Building the monolithic code repository for all Go code in Uber. 
	\begin{itemize}
		\item Developing and optimizing Bazel and its build rules
		\item Developing Gazelle and its extensions to generate build rules, and thus becoming the No. 2 contributor to Bazel Gazelle project on Github
		\item Optimizing Go's official mock generator
		\item Developing dependency manager based on Go modules
		\item Developing Buck macros and adding Go support to Facebook Buck project
	\end{itemize}
}
